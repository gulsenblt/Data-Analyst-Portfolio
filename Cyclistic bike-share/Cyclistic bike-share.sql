...
--STEP 1: Import Data
-----------------------------------------------------------------------------
	--Import two excel data tables  manually, which are Cyclistic’s historical trip data for 2019 and 2020
	-- We have 8 data sets for 2018 and 2019, each for a quarter of the year.

----------------------------------------------------------------------------
--STEP 2:REDUCE DATA AND COMBINE INTO A SINGLE FILE
-----------------------------------------------------------------------------
	--- Since the column names in the 2018_Q1 and 2019_Q2 data are different from those in the other datasets, 
...
----Added new columns for number of day, number of day and rush hours (so we can sort the data by day and month (in sql) and compare by peak or off-peak hours.)
...
-- hourly ridership data by usertype
